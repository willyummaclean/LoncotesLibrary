    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    Name = table.Column<string>(type: "text", nullable: false),
                    DaysCheckedOut = table.Column<int>(type: "integer", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.InsertData(
                table: "Checkouts",
                columns: new[] { "Id", "CheckedOutSince", "MaterialId", "PatronId", "ReturnDate" },
                values: new object[,]
                {
                    { 1, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), 1, 1, null },
                    { 2, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), 2, 2, null },
            ...
            migrationBuilder.InsertData(
                table: "MaterialTypes",
                columns: new[] { "Id", "DaysCheckedOut", "Name" },
                values: new object[,]
                {
                    { 1, 6, "Book" },
                    { 2, 10, "DVD" },
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Cave in the Woods", "patron1@email.com", "Horror", true, "Story" },
                    { 2, "Cabin in the Woods", "patron2@email.com", "Gloria", true, "Hood" },
                    { 3, "Pond in the Woods", "patron3@email.com", "Steve", false, "Tub" }
                });
        }
